...
const DEFAULT_CONFIG: Lazy<OptionalHyprDock> = Lazy::new(|| {
    ...
    OptionalHyprDock {
        ...
        enable_internal_monitor_command: Some(HyprdockCommand::new(fetcher, &[
            "keyword",
            "monitor",
            "{},preferred,0x0,1",
        ])),
        disable_internal_monitor_command: Some(HyprdockCommand::new(fetcher, &[
            "keyword",
            "monitor",
            "{},disabled",
        ])),
        enable_external_monitor_command: Some(HyprdockCommand::new(fetcher, &[
            "keyword",
            "monitor",
            ",preferred,0x0,1",
        ])),
        disable_external_monitor_command: Some(HyprdockCommand::new(fetcher, &[
            "keyword",
            "monitor",
            ",disabled",
        ])),
        extend_command: Some(HyprdockCommand::new(fetcher, &[
            "keyword",
            "monitor",
            ",preferred,1920x0,1",
        ])),
        mirror_command: Some(HyprdockCommand::new(fetcher, &[
            "keyword",
            "monitor",
            ",preferred,0x0,1,mirror,{}",
        ])),
